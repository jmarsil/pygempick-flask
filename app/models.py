...
class Process(db.Model):
    ...
    archive_filename = db.Column(db.String, default=None, nullable=True)
    archive_url = db.Column(db.String, default=None, nullable=True)
...
class Paramas(db.Model):
    ...
    anchor1 = db.Column(db.String, default=None, nullable=True)
    anchor2 = db.Column(db.String, default=None, nullable=True)
    minArea = db.Column(db.String, default=None, nullable=True)
    minCirc = db.Column(db.String, default=None, nullable=True)
    minConc = db.Column(db.String, default=None, nullable=True)
    minIner = db.Column(db.String, default=None, nullable=True)
    comments = db.Column(db.String, default=None, nullable=True)
...
class Task(db.Model):
    ...
    csv_key = db.Column(db.String, default=None, nullable=True)
    csv_sum = db.Column(db.String, default=None, nullable=True)
    zip_name = db.Column(db.String, default=None, nullable=True)
    img_count = db.Column(db.String, default=None, nullable=True)
